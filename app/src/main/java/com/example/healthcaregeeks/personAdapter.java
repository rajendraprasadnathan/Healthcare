...
public class personAdapter extends FirebaseRecyclerAdapter<
                     ...
                     int position, @NonNull person model)
    {
        ...
        // "person.class")to appropriate view in Card
        // view (here "person.xml")
        holder.odour.setText(model.getOdour());
        holder.falldetection.setText(model.getFalldetection());
    ...
    class personsViewholder
        ...
        TextView heartrate, bodytemperature, odour,falldetection;
        public personsViewholder(@NonNull View itemView)
        {
            super(itemView);

            heartrate
                    = itemView.findViewById(R.id.heartrate);
            bodytemperature = itemView.findViewById(R.id.bodytemperature);
            odour = itemView.findViewById(R.id.odour);
            falldetection = itemView.findViewById(R.id.falldetection);
